                        ...
                        switch (command) {
                            ...
                            case "GAME_ATTEND_FAILURE":
                                ...
                                if(reason.statusCode === Status.GameEnded) {
                                    Sorry("This game has already been played and finished!");
                            ...
                            case "TARGET_OFFLINE": {
                                ...
                                Sorry(
                                    "The target user is currently offline. Please try again later."
                                );
                            ...
                            case "YOUR_BUSY": {
                                Sorry(
                                    "You haven't finished your last game yet. Please complete it first and try again."
                                );
                                dispatch(EndFriendlyInvitation());
                                break;
                            }
                            case "TARGET_BUSY": {
                                //... while chatting or game request
                                Notify(
                                    "The target user is currently in another game. Your request cannot be processed right now."
                                );
                                dispatch(EndFriendlyInvitation());
                                break;
                            }
        ...
        <Fragment>
            ...
            >
                ...
                <Modal.Body className="text-left">
                    ...
                    <p>You can decline this request if you don't want to connect.</p>
                </Modal.Body>
                <Modal.Footer className="w-100 text-left">
                    <Row className="w-100">
                        <Col>
                            <Button
                                variant="success"
