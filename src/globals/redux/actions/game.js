...
export const EnterRoom = (room) => {
    return async(dispatch, getState) => {
        ...
        try {
            ...
            Sorry(
                "An error occurred while loading game data. Displayed information may be inaccurate."
            );
...
export const CloseOngoingGame = () => {
    return async(dispatch) => {
        try {
            ...
            Notify("An error occurred while closing the current game.");
        }
    }
}
...
export const RegisterSinglePlayer = (dimension, scoreless, difficulty) => {
    return async(dispatch) => {
        try {
            ...
            console.log(err);
            Sorry("An error occurred while starting single-player mode. Please try again.")
        }
    }
}